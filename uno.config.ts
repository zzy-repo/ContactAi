...
export default defineConfig({
    ...
    shortcuts: {
        ...
        'list-item': 'px-4.5 py-3.5 border-b border-[#f0f4f8] text-sm text-[#4a5568] font-medium cursor-pointer select-none transition-all duration-300 hover:bg-[#f5f7fa] hover:text-[#007bff] hover:translate-x-1.25'
    },
})